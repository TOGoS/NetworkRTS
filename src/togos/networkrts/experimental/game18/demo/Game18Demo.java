...
import togos.networkrts.experimental.game18.sim.Util;
...
public class Game18Demo
{
	...
	public static void main( String[] args ) {
		Tile[] ta = new Tile(Util.NO_ID, "urn:bitprint:EPNJUCXVUO2AVQN4I6OEJ5AVGVOUT3VP.W5JFWDVKZUM6YMMEX5OCZJZCDVONREJQ73O77GI", false, false, BoringestThingBehavior.<Tile>getInstance()).single;
		Tile[] tb = new Tile(Util.NO_ID, "urn:bitprint:QI43S2L5OMDQEFVOMTMMH2IGAIXAFVC5.J4MDMEUBJM3H5D7QUNXXYGMVCSDBJ47ODAZPRZI", true , true , BoringestThingBehavior.<Tile>getInstance()).single;
